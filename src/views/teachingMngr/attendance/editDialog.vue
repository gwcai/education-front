  ...
  <el-dialog :title="title" :visible.sync="visible" :before-close="closeDialog" :close-on-click-modal="false">
    <el-form :model="form" ref="form" :rules="rules">
      ...
      <el-form-item label="考勤状态" :label-width="formLabelWidth">
        <el-input v-model="form.attendance" autocomplete="off"></el-input>
      </el-form-item>
      ...
      <el-form-item label="上课日期" :label-width="formLabelWidth">
        <el-input v-model="form.classDate" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="签到时间" :label-width="formLabelWidth">
        <el-input v-model="form.signTime" autocomplete="off"></el-input>
      </el-form-item>
    </el-form>
