<template>
  <el-form :model="queryForm" ref="queryForm" :inline="true">
    ...
    <el-form-item label="考勤状态" label-width="120px">
      <el-input v-model="queryForm.attendance" autocomplete="off"></el-input>
    </el-form-item>
    <el-form-item label="学生姓名" label-width="120px">
      <el-input v-model="queryForm.studentName" autocomplete="off"></el-input>
    </el-form-item>
    <el-form-item>
